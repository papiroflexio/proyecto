...
<html lang="en">
  <head>
    ...
    <script src="scripts/modificarUsuario.js"></script>
      ...
      <div class="col-sm-12 col-md-5 col-xl-4">
        <div class="row justify-content-center align-items-center text-center">
            <div class="thumbnail">
                  ...
                  <div class="card">
                      <div class="card-body">
                          <form action="" autocomplete="off">
                            ...
                            -->
                            <h4>Aquí puedes modificar tus datos, <?php echo $_SESSION['username']; ?></h4>
                            <?php
              ...
              <button id="eliminarUser" class="form-control btn btn-danger btn-sm my-1 my-sm-0" onclick="deleteUser('<?php echo $_SESSION['username']?>')">Eliminar</button>
            </div>
        </div>
      </div>
    </div>
